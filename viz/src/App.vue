...
import FairBenchmarkView from "./views/FairBenchmarkView.vue";
...
<template>
  <div class="app">
    <header>
      ...
      <p>
        Fair Benchmark 可视化 · Body 机制 · Tier B QA
    ...
    <nav>
      <button :class="{ active: tab === 'fair' }" @click="tab = 'fair'">Fair Benchmark</button>
    ...
    <FairBenchmarkView v-if="tab === 'fair'" />
